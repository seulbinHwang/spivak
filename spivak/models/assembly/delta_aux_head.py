...
class DeltaAuxTrainerHead(TrainerHeadInterface):
    ...
    def __init__(self, delta_aux_predictor_head: "DeltaAuxPredictorHead",
    ...
    def video_targets_shape(self):
        return (None, self._num_classes,
                len(self._radii) * DELTA_TARGET_DIMENSION)
...
class DeltaAuxPredictorHead(PredictorHeadInterface):
    ...
    def __init__(self, name: str, radii: List[float],
    ...
    def create_tensor(self, nodes: Nodes) -> Tensor:
        ...
        return create_cyclic_delta_tensor(self._name, self._num_chunk_frames,
                                          self._num_classes, len(self._radii),
    ...
    def post_process(self, delta_sin_cos):
        ...
        return post_process_cyclic_delta(delta_sin_cos[:, :, :, 0:2],
                                         self._radii[0])
    ...
    def __init__(self, weight, base_loss, n_radii):
        ...
        def cyclic_delta_aux_loss(targets_and_weights, predictions):
            ...
            for target_index in range(n_radii):
                ...
                losses.append(
                    create_cyclic_delta_loss(current_targets,
                                             current_predictions,
                                             current_weights, base_loss))
