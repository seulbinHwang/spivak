...
def create_video_feature_infos(input_dirs: List[Path],
                               input_feature_names: List[str], output_dir: Path,
                               feature_name: str) -> List[VideoFeatureInfo]:
...
def read_and_concatenate_features(features_dir: Path, game_list: List[Path],
...
def _create_video_feature_info(input_paths: List[Path], relative_dir: Path,
                               output_dir: Path,
...
def _read_game_features(game_dir: Path, feature_name: str) -> List[np.ndarray]:
